...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(581, 671)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Dialog.sizePolicy().hasHeightForWidth())
        Dialog.setSizePolicy(sizePolicy)
        Dialog.setMinimumSize(QSize(581, 671))
        Dialog.setMaximumSize(QSize(581, 671))
        Dialog.setSizeIncrement(QSize(581, 671))
        Dialog.setStyleSheet(u"QWidget {\n"
"    background: qlineargradient(x1:0, y1:0, x2:0, y2:1,\n"
"        stop:0 #b5e1c3,\n"
"        stop:1 #7fb5b5);\n"
"}")
        self.input_description = QLineEdit(Dialog)
        self.input_description.setObjectName(u"input_description")
        self.input_description.setGeometry(QRect(80, 240, 431, 51))
        self.input_description.setStyleSheet(u"QLineEdit {\n"
...
"        font-style: italic;\n"
"    }")
        self.input_description.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.label_description_task = QLabel(Dialog)
        self.label_description_task.setObjectName(u"label_description_task")
        self.label_description_task.setGeometry(QRect(120, 110, 311, 111))
        self.label_description_task.setStyleSheet(u"QLabel {\n"
...
"}\n"
"")
        self.add_task_label_des = QLabel(Dialog)
        self.add_task_label_des.setObjectName(u"add_task_label_des")
        self.add_task_label_des.setGeometry(QRect(-20, 10, 651, 101))
        self.add_task_label_des.setStyleSheet(u"QLabel {\n"
...
"}\n"
"")
        self.add_task_label_des.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.add_task_button = QPushButton(Dialog)
        self.add_task_button.setObjectName(u"add_task_button")
        self.add_task_button.setGeometry(QRect(170, 580, 231, 51))
...
"}\n"
"")
        self.input_time_task = QLineEdit(Dialog)
        self.input_time_task.setObjectName(u"input_time_task")
        self.input_time_task.setGeometry(QRect(80, 490, 431, 51))
        self.input_time_task.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid #cccccc;         /* \u0441\u0432\u0435\u0442\u043b\u043e-\u0441\u0435\u0440\u0430\u044f \u0440\u0430\u043c\u043a\u0430 */\n"
"    border-radius: 8px;                /* \u0441\u043a\u0440\u0443\u0433\u043b\u0451\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */\n"
"    padding: 8px 12px;                 /* \u0432\u043d\u0443\u0442\u0440\u0435\u043d\u043d\u0438\u0435 \u043e\u0442\u0441\u0442\u0443\u043f\u044b */\n"
"    font-size: 14pt;                   /* \u0440\u0430\u0437\u043c\u0435\u0440 \u0448\u0440\u0438\u0444\u0442\u0430 */\n"
...
"        font-style: italic;\n"
"    }")
        self.input_time_task.setAlignment(Qt.AlignmentFlag.AlignCenter)
